...
- 🎯 Entry points to execute your program using `python -m <fastapifromtemplate>` or `$ fastapifromtemplate` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/cdescobedo/FastApiFromTemplate/branch/main/graph/badge.svg?token=FastApiFromTemplate_token_here)](https://codecov.io/gh/cdescobedo/FastApiFromTemplate)
[![CI](https://github.com/cdescobedo/FastApiFromTemplate/actions/workflows/main.yml/badge.svg)](https://github.com/cdescobedo/FastApiFromTemplate/actions/workflows/main.yml)

Awesome fastapifromtemplate created by cdescobedo

## Install

from source
```bash
git clone https://github.com/cdescobedo/FastApiFromTemplate fastapifromtemplate
cd fastapifromtemplate
make install
```
...
```bash
pip install fastapifromtemplate
```

## Executing

```bash
$ fastapifromtemplate run --port 8080
```

or

```bash
python -m fastapifromtemplate run --port 8080
```

or

```bash
$ uvicorn fastapifromtemplate:app
```

## CLI

```bash
❯ fastapifromtemplate --help
Usage: fastapifromtemplate [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ fastapifromtemplate create-user --help
Usage: fastapifromtemplate create-user [OPTIONS] USERNAME PASSWORD
...
```bash
fastapifromtemplate create-user admin admin --superuser
```
...
Run with `fastapifromtemplate run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `fastapifromtemplate create-user`.
...
-----------------------------------------------------
fastapifromtemplate/__init__.py              4      0   100%
fastapifromtemplate/app.py                  16      1    94%
fastapifromtemplate/cli.py                  21      0   100%
fastapifromtemplate/config.py                5      0   100%
fastapifromtemplate/db.py                   10      0   100%
fastapifromtemplate/models/__init__.py       0      0   100%
fastapifromtemplate/models/content.py       47      1    98%
fastapifromtemplate/routes/__init__.py      11      0   100%
fastapifromtemplate/routes/content.py       52     25    52%
fastapifromtemplate/routes/security.py      15      1    93%
fastapifromtemplate/routes/user.py          52     26    50%
fastapifromtemplate/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in fastapifromtemplate/default.toml.
