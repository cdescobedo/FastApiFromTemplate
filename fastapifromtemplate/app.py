...
description = """
fastapifromtemplate API helps you do awesome stuff. 🚀
"""

app = FastAPI(
    title="fastapifromtemplate",
    description=description,
    version=read("VERSION"),
    terms_of_service="http://fastapifromtemplate.com/terms/",
    contact={
        "name": "cdescobedo",
        "url": "http://fastapifromtemplate.com/contact/",
        "email": "cdescobedo@fastapifromtemplate.com",
    },
    license_info={
        "name": "The Unlicense",
