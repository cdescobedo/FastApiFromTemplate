...
# WARNING: Ensure imports from `fastapifromtemplate` comes after this line
from fastapifromtemplate import app, settings, db  # noqa
from fastapifromtemplate.cli import create_user, cli  # noqa
